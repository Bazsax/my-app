-- Safe import script for test data
...
-- Insert test transactions (ignore if they already exist)
INSERT IGNORE INTO `cost_entries` (`id`, `user_id`, `type`, `title`, `description`, `amount`, `category`, `subcategory`, `date`, `time`, `transaction_type`, `frequency`, `start_date`, `end_date`, `created_at`, `updated_at`) VALUES
...
-- Insert test custom subcategories (ignore if they already exist)
INSERT IGNORE INTO `custom_subcategories` (`id`, `user_id`, `category_name`, `subcategory_name`, `type`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `cost_entries` AUTO_INCREMENT = 48;
ALTER TABLE `custom_categories` AUTO_INCREMENT = 5;
ALTER TABLE `custom_subcategories` AUTO_INCREMENT = 5;
